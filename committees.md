...
Contact: <a href="mailto:{{ site.conference.email }}">{{ site.conference.email }}</a>
...
TYPES 2027 is organised under the auspices of the TYPES steering committee.

{% include people.html group="steering-committee" %}
